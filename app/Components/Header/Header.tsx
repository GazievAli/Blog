...
export default function Header() {
    const nav_li = ["Home", "About", "Blog", "Contacts", "Projects", "Skills"];
                ...
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    <Link href={"/"} className="flex items-center">
                        <img src="https://flowbite.com/docs/images/logo.svg" className="mr-3 h-6 sm:h-9"
                             alt="Flowbite Logo"/>
                        <span
                            className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Ali Gaziev</span>
                    </Link>
                        ...
                        <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            ...
                            {nav_li.map((item, i) => (
                                <li key={i}>
                                    <Link
                                       href={"/" + (i !== 0 ? item : "")}
                                       className={i == activeLink ? "block py-2 pr-4 pl-3 text-white rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0 dark:text-white" : "block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700"}
                                       aria-current={i == activeLink && "page"}
